...
(function () { 
    window.addEventListener("load", function () {
        setTimeout(function () {
            ...
            logo[0].href = "https://www.easygenerator.com/en/";
            logo[0].target = "_blank"; 
 
            // Section 02 - Set logo
            logo[0].children[0].alt = "Easy Generator";
            logo[0].children[0].src = 'https://www.easygenerator.com/wp-content/uploads/2023/04/easygenerator-footer-logo.png'; 
 
            // Section 03 - Set 32x32 favicon
            var linkIcon32 = document.createElement('link');
            linkIcon32.type = 'image/png';
            linkIcon32.rel = 'icon';
            linkIcon32.href = 'https://www.easygenerator.com/wp-content/uploads/2023/04/easygenerator-footer-logo.png';
            ...
            linkIcon16.rel = 'icon';
            linkIcon16.href = 'https://www.easygenerator.com/wp-content/uploads/2023/04/easygenerator-footer-logo.png';
