...
import mutateData from '../Generic/AJAX/MutateData';
...
const DropdownUser = () => {
  ...
  const handleLogout =   () => {
    ...
    // Find the cookie with the token
    ...
    // Optionally, clear the token from session storage
  ...
  useEffect(() => {//+
    if (userName && document) {//+
      ...
      if (profileImage) {//+
        profileImage.innerText = firstLetter;//+
      }//+
    }//+
  }, []);//+
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full" style={{paddingTop:'5px'}}>
          {/* <img src={UserOne} alt="User" /> */}
          <div className="profile-circle" id="profileImage"></div>
        </span>
